...
OBJ=net.o hiredis.o sds.o dict.o async.o md5.o proxy.o 
...
all: $(DYLIBNAME) $(BINS) hiredis-example-proxy
...
proxy.o: proxy.c hiredis.c dict.c proxy.h hiredis.h dict.h
